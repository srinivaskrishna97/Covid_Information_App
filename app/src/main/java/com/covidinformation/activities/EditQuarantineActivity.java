...
public class EditQuarantineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Edit Quarantine");
    ...
    public  void updateQuarantine() {
        pd= new ProgressDialog(EditQuarantineActivity.this);
        pd.setTitle("Please wait,Data is being submit...");
        pd.show();
        ApiService apiService = RetroClient.getRetrofitInstance().create(ApiService.class);
        Call<ResponseData> call = apiService.editquarantine(spinSelectProvince.getSelectedItem().toString(),
                spinSelectCountry.getSelectedItem().toString(),etDescription.getText().toString(),getIntent().getStringExtra("qid"));
        ...
        call.enqueue(new Callback<ResponseData>() {
            ...
            public void onResponse(Call<ResponseData> call, Response<ResponseData> response) {
                ...
                if (response.body().status.equals("true")) {
                    startActivity(new Intent(EditQuarantineActivity.this, AddQuarantineGuidelinesActivity.class));
                    finish();
                } else {
